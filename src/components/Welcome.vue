...
<template>
  ...
  <WelcomeItem>
    ...
    <a href="https://code.visualstudio.com/" target="_blank">VSCode</a> + <a href="https://github.com/johnsoncodehk/volar" target="_blank">Volar</a>. If you
    need to test your components and web pages, check out <a href="https://vitest.dev" target="_blank">Vitest</a> and maybe not
  ...
  <WelcomeItem>
    ...
    <a target="_blank" href="https://next.vuex.vuejs.org/">Vuex</a>, <a target="_blank" href="https://next.router.vuejs.org/">Vue Router</a>,
